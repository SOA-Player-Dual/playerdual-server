    ...
    <div style="
        ...
        <div style="
            ...
            <div>
                ...
                <p style="font-size: 1.1em">Chào, {{$mailData['username']}}</p>
                <p>Bạn đang tiến hành khôi phục mật khẩu</p>
                <p>
                    Sử dụng mã OTP dưới đây để hoàn thành việc xác minh và thay đổi mật khẩu.
                </p>
                <h2 style="
                            background: #fe2c55;
                            margin: 0 auto;
