    ...
    <div style="
        ...
        <div style="
            ...
            <div>
                ...
                <p>Đang có một yêu cầu được chơi game cùng với bạn:</p>
                <p>Thông tin chi tiết:</p>
                <div style="padding: 0 0 0 32px">
                    <p style="margin: 0; opacity: 0.6">
                        Người dùng đang thuê bạn: {{$mailData['name']}}
                    </p>
                    <p style="margin: 0; opacity: 0.6">
                        Thời gian: {{$mailData['time']}}
                    </p>
                    <p style="margin: 0">
                        <span style="opacity: 0.6">Phí: {{$mailData['fee']}}</span>
                        <span style="opacity: 1; color: #fe2c55">VND</span>
                    </p>
                </div>
                <p>
                    Bạn hãy nhanh chóng truy cập vào trang chủ PlayerDual để chấp nhận yêu cầu này nhé!
                </p>
                <h2 style="
                            background: #fe2c55;
                            margin: 0 auto;
            ...
            <div style="
                ...
                <p style="margin: 0; padding-bottom: 8px">
                    Copyright © 2022 PlayerDual Team
                </p>
                <p style="margin: 0; padding-bottom: 8px">
